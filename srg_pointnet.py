...
parser = argparse.ArgumentParser(description='SRG Pointnet')
...
with open(f'result/{data_location}/srg_pointnet_label.txt', 'w') as file:
...
with open(f'result/{data_location}/srg_pointnet_result.txt', 'w') as file:
    for i, line in enumerate(color_cloud):
        file.write(f'{line[0]}; {line[1]}; {line[2]}; {line[3]}; {line[4]}; {line[5]}\n')

with open(f'result/{data_location}/srg_pointnet_iou.txt', 'w') as file:
